...
const Pembahasan= () => {
    ...
    return (
      <div className='px-10 py-5 mx-auto '>
        <h1 className="text-2xl font-bold text-[#b32553] bg-[#e18da8] text-center w-[30%] py-2 rounded-2xl mb-2 mx-auto">Pembahasan</h1>
          ...
          {/* untuk nomor perpindahan soal */}
            ...
            {Questions.map((question, index) => (
              <button
                key={question.id}
                className={
                            `question-button2 ${question.id === Questions[currentQuestion].id ? 'active' : ''}`
                          }
                onClick={() => {
